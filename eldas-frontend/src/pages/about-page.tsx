      ...
      <Card className="bg-white/90 p-8">
        <div className="flex flex-col items-center gap-8 md:flex-row md:items-start">
          <img
            src="/vishnu.png"
            alt="Vishnu Das"
            className="h-40 w-40 rounded-3xl object-cover flex-shrink-0"
          />
          <div>
            <h2 className="font-display text-3xl font-bold text-ink">Vishnu Das</h2>
            <p className="mt-1 text-sm font-semibold text-tide">Founder and CEO, Eldas</p>
            <a
            ...
            <p className="mt-4 text-sm leading-7 text-slate-500">
              An aspiring entrepreneur with a passion for edtech, Vishnu excels in startup orchestration, from
              crafting compelling pitch decks to navigating deployment challenges. Based in Bengaluru, he draws
              inspiration from India's vibrant tech ecosystem, advocating for AI as a catalyst for equitable
              education.
            </p>
          </div>
        </div>
